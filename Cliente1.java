...
public class Cliente1 {
    ...
    public Cliente1(String nombre, Map<String, String> configuracion, Map<String, String> topologia) {
        this.nombre = nombre;
    ...
    public static void main(String[] args) {
        ...
        Cliente1 cliente = new Cliente1(nombreCliente, configuracion, topologia);
        cliente.start();
