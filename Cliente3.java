...
public class Cliente3 {
    ...
    public Cliente3 (String nombre, Map<String, String> configuracion, Map<String, String> topologia) {
        this.nombre = nombre;
    ...
    public static void main(String[] args) {
        ...
        Cliente3 cliente = new Cliente3(nombreCliente, configuracion, topologia);
        cliente.start();
